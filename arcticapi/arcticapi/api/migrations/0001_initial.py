# Generated by Django 3.0.3 on 2020-04-07 19:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('donators', models.DecimalField(decimal_places=2, max_digits=20)),
                ('days_active', models.DecimalField(decimal_places=2, max_digits=20)),
                ('title', models.TextField()),
                ('description', models.TextField()),
                ('user_first_name', models.TextField()),
                ('user_last_name', models.TextField()),
                ('campaign_image_url', models.TextField()),
                ('campaign_hearts', models.DecimalField(decimal_places=2, max_digits=20)),
                ('social_share_total', models.DecimalField(decimal_places=2, max_digits=20)),
